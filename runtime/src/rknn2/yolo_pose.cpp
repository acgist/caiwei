...
caiwei::context::PoseRKNN2Context::PoseRKNN2Context(std::string path, int w, int h, int top_k, int class_size, float confidence_threshold, std::shared_ptr<caiwei::runtime::RKNN2Runtime> runtime)
 : PoseContext(w, h, top_k, class_size, confidence_threshold, runtime),
   RKNN2Context(path) {
