...
// static std::string format_reranker_prompt(const char *instruction, const std::string& query, const std::string& doc)
// {
...
//     // TODO
//     std::string query = std::get<std::string>(request.query);
//     for (const auto& item : request.documents) {
